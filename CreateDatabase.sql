-- ============================================================================
-- Second Brain MCP Server - Complete Database Creation Script
-- ============================================================================
-- This script contains ALL SQL commands necessary to create a fresh database
-- for Second Brain MCP Server with Supabase (PostgreSQL + pgvector)
--
-- Usage:
--   1. Open Supabase SQL Editor
--   2. Copy and paste this entire script
--   3. Execute all commands together
--
-- Order of Execution:
...
--   - pgvector extension enabled (via dashboard or this script)
-- ============================================================================
...
-- Create trigger on thoughts table for content_tsv updates
...
--
-- Next steps:
-- 1. Verify all tables have been created (see verification queries above)
